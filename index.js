...
// const p1 = new LLJSPromise((resolve, reject) => {
//   console.log('promise');
...
//   console.log('then');
//   console.log(res);
//   return new LLJSPromise(resolve => {
...
let p1 = new LLJSPromise((resolve, reject) => {
  setTimeout(() => reject('resolved first one'), 1000);
});
p1.then((res) => {
  console.log(res);
  return new LLJSPromise((resolve, reject) => {
